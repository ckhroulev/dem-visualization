...
parser.add_argument("-c", dest="colormap", help="matplotlib colormap name", default="Spectral")
...
if options.texture:
    try:
        ...
        print "Unknown colormap name, %s. Using \"Spectral\" instead." % options.colormap
        cmap = plt.cm.get_cmap("Spectral")
    array_to_image(data, cmap, log10=options.log).save(options.output)
else:
